...
import type { PoimuColors, PoimuParams } from "./poimu-field.js";

export interface PoimuFrame {
  time: number;
...
export function setPoimuColors(u: Uniforms, colors: PoimuColors): void {
  setUniform(u, "uKeyColor", [...colors.key]);
  setUniform(u, "uFillColor", [...colors.fill]);
  setUniform(u, "uRimColor", [...colors.rim]);
}

export function setPoimuParams(u: Uniforms, params: PoimuParams): void {
...
export function setPoimuFrame(u: Uniforms, frame: PoimuFrame): void {
