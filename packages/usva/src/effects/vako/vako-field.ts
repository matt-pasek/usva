...
export const VAKO_DEFAULTS: VakoParams = {
  origin: [-1.05, 0.78],
  spin: (2 * Math.PI) / 90,
  furrowFreq: 16,
  warpAmt: 2.8,
...
export function resolveParams(overrides: Partial<VakoParams> = {}): VakoParams {
  const merged = { ...VAKO_DEFAULTS, ...overrides };
  return {
    ...merged,
