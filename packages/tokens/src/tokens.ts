...
export const tokens = {
  ...
  text: { xs: "0.75rem", sm: "0.875rem", base: "1rem", lg: "1.125rem", xl: "1.25rem", "2xl": "1.5rem", "3xl": "1.875rem", "4xl": "2.25rem" },
  motion: {
    duration: { fast: "120ms", base: "200ms", slow: "360ms" },
    easing: { standard: "cubic-bezier(0.2,0,0,1)", entrance: "cubic-bezier(0,0,0,1)", exit: "cubic-bezier(0.3,0,1,1)" },
    spring: {
