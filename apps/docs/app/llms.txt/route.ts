...
const body = (): string =>
  [
    ...
    `- [skill.md](${SITE_ORIGIN}/skill.md): this library as an installable agent skill, with the failure modes.`,
    ...
    "",
    "this file is an index. it tells you what exists, not how to hold it. the skill",
    "does that, and it carries the failure modes this library has already been bitten",
    "by, every one of which passes a build:",
    "",
    "```",
    ...
    "```",
    "",
    "no agent skills in your harness? save it as AGENTS.md, or paste it as a system",
    "prompt. failing that, the shortest useful prompt, copy it as is:",
    "",
    "```",
