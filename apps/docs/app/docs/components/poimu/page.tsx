...
import { PoimuDemo } from "./poimu-demo";

export const metadata: Metadata = {
  title: "Poimu",
  description:
    "Poimu: a vast sheet of silk, creased and lit from three sides. The colour is what the light does to the folds, never a sampled palette.",
};
...
const usage = `import { Poimu } from "@matt-pasek/usva";

<Poimu className="min-h-svh">
  <Hero />
</Poimu>`;
...
export default function PoimuPage() {
  return (
    <main className="mx-auto flex max-w-5xl flex-col gap-8 p-10">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-semibold text-ink">Poimu</h1>
        <p className="text-muted">
          Poimu is Finnish for a pleat. It is a sheet of silk far larger than
          the frame, creased three times and lit by three coloured lamps.
          Everything you see is the lighting: a fold turning toward the key lamp
          takes its hue, the same fold rolling away catches the fill, a crest
          grazed by the rim picks up a thin sheen, and the ground is black
      ...
      <Card>
        ...
        <CardBody className="flex flex-col gap-3">
          <InstallBlock registryName="poimu" />
          <p className="text-sm text-muted">
      ...
      <Card>
        ...
        <CardBody className="flex flex-col gap-4">
          <SourceView filePath="packages/usva/src/effects/poimu/poimu.tsx" />
          <SourceView filePath="packages/usva/src/effects/poimu/poimu-field.ts" />
          <SourceView filePath="packages/usva/src/effects/poimu/poimu-uniforms.ts" />
          <SourceView filePath="packages/usva/src/effects/poimu/poimu-shader.ts" />
        </CardBody>
      </Card>
