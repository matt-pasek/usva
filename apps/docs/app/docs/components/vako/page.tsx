...
import { VakoDemo } from "./vako-demo";

export const metadata: Metadata = {
  title: "Vako",
  description:
    "Vako: the furrow a thumb leaves in a thrown pot. A vast clay surface turning on a wheel, lit by one raking key, with no specular anywhere.",
};
...
const usage = `import { Vako } from "@matt-pasek/usva";

<Vako className="min-h-svh">
  <Hero />
</Vako>`;
...
export default function VakoPage() {
  return (
    <main className="mx-auto flex max-w-5xl flex-col gap-8 p-10">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-semibold text-ink">Vako</h1>
        <p className="text-muted">
          Vako is Finnish for a furrow. One vast clay surface seen from above,
          still turning on a wheel far slower than you first notice. Concentric
          thumb-drawn grooves wobble, thicken, break and re-form, each holding a
          crescent of warm shadow on one side and a dry pale ridge on the other.
          It is the savi background, and the cheapest effect here: a
          screen-space heightfield, no raymarch.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardBody>
          <p className="text-sm text-muted">
            ...
            blend mode on the canvas: vako is the ground, not a stain on it, so
      ...
      <Card>
        ...
        <CardBody className="flex flex-col gap-3">
          <InstallBlock registryName="vako" />
          <p className="text-sm text-muted">
      ...
      <Card>
        ...
        <CardBody className="flex flex-col gap-4">
          <SourceView filePath="packages/usva/src/effects/vako/vako.tsx" />
          <SourceView filePath="packages/usva/src/effects/vako/vako-field.ts" />
          <SourceView filePath="packages/usva/src/effects/vako/vako-uniforms.ts" />
          <SourceView filePath="packages/usva/src/effects/vako/vako-shader.ts" />
        </CardBody>
      </Card>
